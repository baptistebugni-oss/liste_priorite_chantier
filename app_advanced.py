...
def build_pdf_liste(df, opts, qr_url=None):
    ...
    for _, row in df_sorted.iterrows():
        ...
        # ==============================
    # SECTION 2 : VUE PAR SEMAINE
    # ==============================

    # Espace avant d’attaquer la timeline
    y -= 30
    ...
    if not df_week.empty:
        ...
        for (year, week), g in df_week.groupby(["year", "week"]):
            ...
            for _, row in g.iterrows():
                ...
                # Pastille urgence
                draw_circle(c, margin_left + 5, y - 4, 4, urg)
                ...
                # Pastille statut
                draw_circle(c, margin_left + 18 + 300, y - 4, 4, stat_hex)

                y -= 16

    else:
        c.drawString(margin_left, y, "Aucune date disponible pour générer la vue par semaine.")
        y -= 20
